...
# Initialisation de l'application Dash avec police Google Fonts
app = dash.Dash(
    __name__,
...
# Style global avec fond en dégradé
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            ...
            dcc.DatePickerRange(
                ...
                style={"backgroundColor": "#e3f2fd", "borderRadius": "5px", "padding": "5px"}
            ),
        ], width=6),
        ...
        dbc.Col([
            ...
            dcc.Dropdown(
                ...
                value="5min",
                style={"backgroundColor": "#e3f2fd", "borderRadius": "5px", "color": "black"}
            )
        ], width=6)
    ], className="mb-4"),
    ...
    "background": "radial-gradient(circle at center, #1e3c72, #0d1b2a)",
    "minHeight": "100vh",
    "padding": "40px"
})
...
def update_dashboard(n, start_date, end_date, agg):
    ...
    stats = (f"ETH: {latest_price:.2f} USDT (à {latest_time}) | "
             f"Moyenne: {moyenne:.2f} USDT | Variation: {variation:.2f}%")
