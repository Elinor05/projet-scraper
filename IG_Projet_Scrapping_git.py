    ...
    dbc.Row([
        dbc.Col([
            ...
            dcc.DatePickerRange(
                ...
                style={"backgroundColor": "#1f3b5c", "borderRadius": "5px", "color": "white"}
            ),
            html.Br(), html.Br(),
            ...
            dcc.Dropdown(
                ...
                style={"width": "60%", "borderRadius": "5px", "backgroundColor": "#1f3b5c", "color": "white"}
            )
        ], width=6),
        ...
        dbc.Row([
            dbc.Col([
                dbc.Table([
                    ...
                    html.Tbody([
                        html.Tr([html.Td("Volatilité (écart-type)", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{volatility:.4f}")]),
                        html.Tr([html.Td("Prix max", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{prix_max:.4f}")]),
                        html.Tr([html.Td("Prix min", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{prix_min:.4f}")]),
                        html.Tr([html.Td("Moyenne", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{moyenne:.4f}")])
                    ])
                ], bordered=True, style={"color": "white", "fontSize": "14px", "backgroundColor": "#1f3b5c"})
            ], width=6),
            ...
            dbc.Col([
                dbc.Table([
                    ...
                    html.Tbody([
                        html.Tr([html.Td("Plus forte hausse", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{max_rise:.2f}% le {max_rise_day}")]),
                        html.Tr([html.Td("Journée la plus volatile", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{most_volatile:.2f} le {most_volatile_day}")]),
                        html.Tr([html.Td("Prix le plus bas", style={"color": "lightgray", "fontWeight": "bold"}), html.Td(f"{lowest_price:.2f} le {lowest_price_day}")])
                    ])
                ], bordered=True, style={"color": "white", "fontSize": "14px", "backgroundColor": "#1f3b5c"})
            ], width=6)
        ])
