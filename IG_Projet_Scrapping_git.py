...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col([
            html.H4("Graphique des prix ETH", style={"color": "white", "textAlign": "center"}),
    ...
    dbc.Row([
        dbc.Col([
            html.H4("Variation quotidienne ETH", style={"color": "white", "textAlign": "center"}),
...
def update_dashboard(n, start_date, end_date, agg):
    ...
    figure_main = {
        ...
        "layout": {
            ...
            "plot_bgcolor": "#1b263b", "paper_bgcolor": "#1b263b",
            "font": {"color": "white"}
        }
    }
    ...
    figure_var = {
        "data": [go.Bar(x=variation.index.astype(str), y=variation.values, marker_color=colors)],
        "layout": {
            "xaxis": {"title": "Date"},
