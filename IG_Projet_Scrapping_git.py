...
app.layout = dbc.Container([
    ...
    # Filtres et statistiques déplacés ici, en dessous
    dbc.Row([
        dbc.Col([
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    html.Div(id="advanced-stats", style={"color": "white", "fontSize": "16px"})
                ])
...
def update_dashboard(n, start_date, end_date, agg):
    ...
    stats_main = html.Span([
        ...
        html.Br(),
        html.Span(f"À la clôture : {latest_time.strftime('%d %b %Y à %H:%M:%S')}", style={"fontSize": "16px", "color": "white"})
    ])
    ...
    stats_adv = html.Div([
        dbc.Row([
            dbc.Col([
                ...
                ], bordered=True, style={"fontSize": "16px", "backgroundColor": "#1f3b5c"})
            ], width=6),
