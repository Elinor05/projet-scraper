    ...
    dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    html.Div(id="advanced-stats", style={"fontSize": "15px"})
                ])
        ...
        dbc.Row([
            dbc.Col([
                dbc.Table([
                    ...
                    html.Tbody([
                        html.Tr([html.Td("Volatilité (écart-type)", style={"fontWeight": "bold"}), html.Td(f"{volatility:.4f}")]),
                ...
                ], bordered=True, style={"color": "black", "fontSize": "14px", "backgroundColor": "#1f3b5c"})
            ], width=6),
